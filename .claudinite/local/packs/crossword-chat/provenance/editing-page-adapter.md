## 2026-08-07 · born · write down what you verified the selectors against (#130)
...
- **Mechanism:** a RULES.md rule in `local/crossword-chat`, triggered on "Editing
  page-adapter/selectors.js"; the general rule is canon `host-page`'s.
