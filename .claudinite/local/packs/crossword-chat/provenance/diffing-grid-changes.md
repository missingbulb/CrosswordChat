## 2026-08-07 · born · the pause veil, in the lifecycle section (#130)
...
- **Mechanism:** a RULES.md rule in `local/crossword-chat`, triggered on "Diffing the grid for
  changes"; the general overlay rule is canon `host-page`'s.
