## 2026-08-07 · born · ship a probe that never throws (#130)
...
- **Mechanism:** a RULES.md rule in `local/crossword-chat`, triggered on "Hearing that the extension
  stopped working"; the general probe rule is canon `host-page`'s.
