...
| `stt-interim-results-gated` | interim transcripts gated on isFinal | blocking |
...
| endpointing fails; monitor mid-utterance pauses | prose (that interims aren't delivered is checked) |
