...
export const DEFAULT_BIASING = 'off';
...
export const BIASING_CHOICES = [
  { value: 'off', label: 'No biasing experiments',
    hint: 'Default. Recognition runs exactly as it does today.' },
  { value: 'commands', label: 'Experimental 1 — Commands & clue labels',
    hint: 'Nudges recognition toward voice commands and this puzzle’s clue numbers (“12 across”).' },
